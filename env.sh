...
conda create --name doo python=3.11 numpy Cython scipy h5py matplotlib tqdm ipython scikit-learn tensorboard ipython imageio scikit-image future colorama
